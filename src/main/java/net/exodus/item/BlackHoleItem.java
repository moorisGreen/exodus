...
import net.exodus.procedures.DropBlackHoleProcedure;
...
public class BlackHoleItem extends ExodusModElements.ModElement {
	@ObjectHolder("exodus:blackhole")
	public static final Item block = null;
	public BlackHoleItem(ExodusModElements instance) {
		super(instance, 24);
	}
