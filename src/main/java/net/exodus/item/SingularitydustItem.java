...
public class SingularitydustItem extends ExodusModElements.ModElement {
	@ObjectHolder("exodus:singularitydust")
	public static final Item block = null;

	public SingularitydustItem(ExodusModElements instance) {
		super(instance, 4);
	}
