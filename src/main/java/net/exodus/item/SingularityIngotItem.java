...
public class SingularityIngotItem extends ExodusModElements.ModElement {
	@ObjectHolder("exodus:singularity_ingot")
	public static final Item block = null;

	public SingularityIngotItem(ExodusModElements instance) {
		super(instance, 8);
	}
