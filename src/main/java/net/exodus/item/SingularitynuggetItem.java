...
public class SingularitynuggetItem extends ExodusModElements.ModElement {
	@ObjectHolder("exodus:singularitynugget")
	public static final Item block = null;

	public SingularitynuggetItem(ExodusModElements instance) {
		super(instance, 6);
	}
