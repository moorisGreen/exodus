...
import net.exodus.entity.renderer.ExodusBowRenderer;
...
public class ExodusBowItem extends ExodusModElements.ModElement {
	@ObjectHolder("exodus:exodus_bow")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletexodus_bow").setRegistryName("entitybulletexodus_bow");

	public ExodusBowItem(ExodusModElements instance) {
		super(instance, 99);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ExodusBowRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(ExodusItemGroup.tab).maxStackSize(1));
			setRegistryName("exodus_bow");
		}
	...
	public static ArrowCustomEntity shoot(LivingEntity entity, LivingEntity target) {
		...
		entityarrow.setSilent(true);
		entityarrow.setDamage(Double.MAX_VALUE);
