...
import net.exodus.procedures.BlackTntreplaceProcProcedure;
...
public class BlackTNTBlock extends ExodusModElements.ModElement {
	@ObjectHolder("exodus:black_tnt")
	public static final Block block = null;

	public BlackTNTBlock(ExodusModElements instance) {
		super(instance, 69);
	}
