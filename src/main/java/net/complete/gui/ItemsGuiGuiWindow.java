...
public class ItemsGuiGuiWindow extends ContainerScreen<ItemsGuiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("complete:textures/items_gui.png");
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 62, this.guiTop + 53, 46, 20, new StringTextComponent("Save"), e -> {
			if (true) {
				CompleteMod.PACKET_HANDLER.sendToServer(new ItemsGuiGui.ButtonPressedMessage(0, x, y, z));
