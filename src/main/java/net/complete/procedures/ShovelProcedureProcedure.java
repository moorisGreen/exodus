	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				CompleteMod.LOGGER.warn("Failed to load dependency x for procedure ShearProcedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				CompleteMod.LOGGER.warn("Failed to load dependency y for procedure ShearProcedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				CompleteMod.LOGGER.warn("Failed to load dependency z for procedure ShearProcedure!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				CompleteMod.LOGGER.warn("Failed to load dependency world for procedure ShearProcedure!");
			return;
		}
		...
		while (true) {
			...
			for (int index1 = 0; index1 < (int) (3); index1++) {
				...
				for (int index2 = 0; index2 < (int) (3); index2++) {
					...
					block = world.getBlockState(new BlockPos((int) (x1 + x2), (int) (y1 + y2), (int) (z1 + z2)));
						if (block.getMaterial() == net.minecraft.block.material.Material.EARTH
				|| block.getMaterial() == net.minecraft.block.material.Material.CLAY
				|| block.getMaterial() == net.minecraft.block.material.Material.SNOW_BLOCK
				|| block.getMaterial() == net.minecraft.block.material.Material.SNOW
				|| block.getMaterial() == net.minecraft.block.material.Material.SAND
				|| block.getMaterial() == net.minecraft.block.material.Material.ORGANIC
				|| block.getMaterial() == net.minecraft.block.material.Material.EARTH) {
