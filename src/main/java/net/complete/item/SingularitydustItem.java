...
public class SingularitydustItem extends CompleteModElements.ModElement {
	@ObjectHolder("complete:singularitydust")
	public static final Item block = null;

	public SingularitydustItem(CompleteModElements instance) {
		super(instance, 4);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("singularitydust");
		}
