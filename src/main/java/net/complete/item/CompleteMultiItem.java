...
public class CompleteMultiItem extends CompleteModElements.ModElement {
	@ObjectHolder("complete:complete_multi")
	public static final Item block = null;
	public CompleteMultiItem(CompleteModElements instance) {
		super(instance, 69);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("complete_multi"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(null).maxDamage(0).isImmuneToFire());
		}
		...
		public boolean canHarvestBlock(BlockState state) {
			return 2147483647 >= state.getHarvestLevel();
		}
