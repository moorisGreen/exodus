...
import net.complete.procedures.BlackTntreplaceProcProcedure;
...
public class BlackTNTBlock extends CompleteModElements.ModElement {
	@ObjectHolder("complete:black_tnt")
	public static final Block block = null;

	public BlackTNTBlock(CompleteModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				BlackTntreplaceProcProcedure.executeProcedure(Stream
